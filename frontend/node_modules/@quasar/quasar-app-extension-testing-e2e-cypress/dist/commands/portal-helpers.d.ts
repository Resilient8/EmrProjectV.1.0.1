...
declare global {
    namespace Cypress {
        interface Chainable {
             ...
             */
            withinPortal<E extends HTMLElement = HTMLElement>(selectorOrOptions: string | WithinPortalOptions, fn: WithinPortalCallback<E>): Chainable<JQuery<E>>;
            /**
             ...
             */
            withinSelectMenu<E extends HTMLElement = HTMLElement>(fnOrOptions: WithinPortalCallback<E> | WithinPortalDerivateOptions<E>): Chainable<JQuery<E>>;
            /**
             ...
             */
            withinMenu<E extends HTMLElement = HTMLElement>(fnOrOptions: WithinPortalCallback<E> | WithinPortalDerivateOptions<E>): Chainable<JQuery<E>>;
            /**
             ...
             */
            withinDialog<E extends HTMLElement = HTMLElement>(fnOrOptions: WithinPortalCallback<E> | WithinPortalDerivateOptions<E>): Chainable<JQuery<E>>;
        }
    }
}
type WithinPortalCallback<E extends HTMLElement = HTMLElement> = (currentSubject: JQuery<E>) => void;
...
export declare function registerPortalHelpers(): void;
export {};
