...
exports.registerColorAssertions = void 0;
const COLOR_RELATED_CSS_PROPERTIES = [
    'color',
    'backgroundColor',
];
function registerColorAssertions() {
    ...
    for (const property of COLOR_RELATED_CSS_PROPERTIES) {
        chai.Assertion.addMethod(property, function (colorValue) {
            // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment
            const targetElement = this._obj;
            ...
            this.assert(actual === expected, `expected #{this} to have ${property} #{exp}, but got #{act} instead`, `expected #{this} not to have ${property} #{exp}`, expected, actual);
        });
    }
}
exports.registerColorAssertions = registerColorAssertions;
//# sourceMappingURL=color-assertions.js.map